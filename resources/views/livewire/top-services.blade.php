            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="banner__sidebar position__relative">
                        <a class="banner__thumbnail display-block" href="https://www.sberbank.com/ru/s_m_business/new_sbbol" target="_blank"><img class="banner__thumbnail--img" src="{{ asset('resources/img/banner/banner-bank.webp') }}" alt="banner-bank"></a>
                    </div>
                </div>
            </div>
        </div>
