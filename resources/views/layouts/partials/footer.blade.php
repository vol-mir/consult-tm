...
<footer class="footer__section footer__bg">
    ...
    <div class="footer__bottom">
        <div class="container">
            ...
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <p class="footer__text--info text-center">Обращаем ваше внимание на то, что данный интернет-сайт носит исключительно информационный характер и ни при каких условиях не является публичной офертой. Для получения подробной информации о стоимости оказываемых услуг и их наличии, пожалуйста, обращайтесь к нашим специалистам. Лицензия на оказание юридических услуг №02240/2539, выдана решением Министерства Юстиции Республики Беларусь</p>
            </div>
        </div>
    </div>
</footer>
